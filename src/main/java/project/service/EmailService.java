...
public class EmailService{
	...
	public void sendValidateMail(String email, int code){
        ...
        try {
            ...
            mimeMessageHelper.setText(getCodeEmailHtml(code), true); // 메일 본문 내용, HTML 여부
    ...
    private String getCodeEmailHtml(int code){
        return String.format(MAIL_MESSAGE, MAIN_URL, code);
    }
}