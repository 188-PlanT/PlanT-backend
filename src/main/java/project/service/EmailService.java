...
public class EmailService{
	...
	public void sendInvitationMail(String email, String inviter, String workspaceName){
		String subject = "[PLANT] 워크스페이스에 초대합니다";
		sendMail(email, subject, getInvitationEmailContent(inviter, workspaceName));
	}
	...
	public String getInvitationEmailContent(String inviter, String workspaceName){
		return String.format(INVITATION_MAIL_MESSAGE, MAIN_URL, inviter, workspaceName, INVITE_URL);
	}
}