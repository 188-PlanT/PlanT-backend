...
public class UserUtil {
    ...
    public UserRole getLoginUserRole(Long workspaceId) {
        ...
        if (userInfo.getWorkspaceUserIds().stream().anyMatch((workspaceUserId) -> workspaceUserId.equals(workspaceId)))
    ...
    public User getUserById(Long userId) {
        return userRepository.findById(userId).orElseThrow(() -> new PlantException(ErrorCode.USER_NOT_FOUND));
    }
