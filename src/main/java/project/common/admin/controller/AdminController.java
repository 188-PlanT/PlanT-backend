...
public class AdminController {
    ...
    public String loginUser(
            @Valid LoginRequest loginRequest, BindingResult bindingResult, Model model, HttpServletRequest request) {
        ...
        try {
            ...
            User loginUser = userRepository.findByEmail(loginRequest.getEmail()).orElseThrow();
